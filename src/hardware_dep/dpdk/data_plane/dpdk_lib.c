...
static struct rte_eth_rxconf rx_conf = {
        .rx_thresh = {
                .pthresh = MAX_PKT_BURST,
                .hthresh = MAX_PKT_BURST,
                .wthresh = 0,
        },
        .rx_free_thresh = MAX_PKT_BURST,	//BS
        .rx_drop_en = 0,
};

static struct rte_eth_txconf tx_conf = {
        .tx_thresh = {
                .pthresh = MAX_PKT_BURST,	//BS
                .hthresh = 0,
                .wthresh = 0,
        },
        .tx_free_thresh = MAX_PKT_BURST, 	//BS
        .tx_rs_thresh = MAX_PKT_BURST,		//BS
...
#define RTE_TEST_RX_DESC_DEFAULT  (MAX_PKT_BURST == 1)?8:4*MAX_PKT_BURST //4*BS
#define RTE_TEST_TX_DESC_DEFAULT  16*MAX_PKT_BURST//(MAX_PKT_BURST <= 64)?16*MAX_PKT_BURST:1024 //16*BS
...
static struct rte_eth_conf port_conf = {
	.rxmode = {
		...
		.hw_ip_checksum = 0, /**< IP checksum offload enabled */ //TODO
		.hw_vlan_filter = 0, /**< VLAN filtering disabled */
		.jumbo_frame    = 0, /**< Jumbo Frame Support disabled */
		.hw_strip_crc   = 0, /**< CRC stripped by hardware */    //TODO
		.enable_lro 	= 0, /*Large recieve offload */ 	//TODO
	},
	.rx_adv_conf = {
		.rss_conf = {
			.rss_key = NULL,
